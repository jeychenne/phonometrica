...
#include <phon/engine/concurrency/parallel.hpp> // vm_parallel_map
#include <phon/engine/lib/lib.hpp>
#include <phon/engine/object/value_ops.hpp> // value_equals / value_compare
#include <phon/engine/runtime/native_traits.hpp>
#include <phon/engine/types/list.hpp>
#include <phon/engine/types/string.hpp>
#include <phon/engine/vm/interpreter.hpp> // stringify (for join)
