...
#include <phon/engine/core/cell.hpp>    // retain/release for cell-valued constants
#include <phon/engine/vm/function.hpp> // deref() reads through a first-class reference argument
