...
#include <phon/engine/concurrency/parallel.hpp> // freeze_reachable_constants
#include <phon/engine/concurrency/transfer.hpp>
#include <phon/engine/core/cell.hpp>
#include <phon/engine/object/generic.hpp> // dispatch_enter_thread/exit (memo concurrency guard)
