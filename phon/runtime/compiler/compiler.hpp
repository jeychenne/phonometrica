...
private:
	...
	bool visiting_constructor() const { return creating_ctor; }

	void set_variable(Ast *node, const String &name);
	...
	// Name of the class being visited, so that we can refer to it in methods.
	...
	// Flag for class constructors.
	bool creating_ctor = false;
