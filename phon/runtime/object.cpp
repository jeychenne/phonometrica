...
Class *Object::get_runtime_class() const
{
	if (this->is_instance())
	{
		auto &instance = static_cast<const TObject<Instance>*>(this)->value();
		return instance.get_class().get();
	}
	else
	{
		return klass;
...
bool Object::is_instance() const noexcept
{
	return klass == Class::get<Instance>();
}
