...
- **Statistical modeling** (preview/beta): fit linear, logistic, Poisson, and negative binomial regression models with fixed and random effects (LMM/GLMM); post-hoc testing (estimated marginal means);  model comparison with LRT and information criteria; diagnostic plots and exploratory visualizations.
