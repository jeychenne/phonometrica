...
* FFTW, by Matteo Frigo and contributors (GPL 2 or later), see `www.fftw.org <http://www.fftw.org>`_
...
* utf8proc, by JuliaStrings and the Public Software Group (MIT), see `julialang.org/utf8proc <https://juliastrings.github.io/utf8proc/>`_
